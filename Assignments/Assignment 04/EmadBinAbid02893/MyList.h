...
public:
    ...
    MyList(int);                        ///creates a stack of some initial length           ///Implemented
    ...
    int PopAt(int);                     ///takes an integer and removes it from this list   ///Implemented
    ...
    MyList operator+(const MyList&);    ///appends a MyList in the end of this list         ///Implemented
    MyList operator-(int);              ///removes passed values from this list             ///Implemented
    int& operator[](int);               ///reads/writes values at particular index          ///Implemented
